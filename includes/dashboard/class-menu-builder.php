...
class Serene_Panel_Menu_Builder {
    ...
    public static function get_menu_items() {
        ...
        // Strip Pro items in Lite edition
        unset($custom_menu['lucky_wheel'], $custom_menu['rewards'], $custom_menu['affiliate']);

        // Auto-merge any newly added standard features
